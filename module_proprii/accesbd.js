...
class AccesBD{
     ...
     * @returns {AccesBD}
     */
    //INTR O METODA STATICA ,THIS ESTE CLASA!!!# insmn privat
    //singleton-pot crea o singura instanta
    static getInstanta({init="local"}={}){ //AccessBD.getInstanta({init:"render"}),obiectul vid daca parantezele sunt goale
    ...
    insert({tabel="",campuri={}} = {}, callback){ //AccesBD.getInstanta().insert({tabel:"produse",campuri:{nume:"savarina",pret:"10"}})
        console.log("-------------------------------------------")
...
module.exports=AccesBD;// require in programul principal